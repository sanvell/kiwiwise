        ...
        <section className="mt-24">
            ...
            <div className="grid sm:grid-cols-1 md:grid-cols-3 gap-8">
                <Card className="text-center">
                    ...
                    <CardContent>
                        <p className="text-muted-foreground">
                            To provide every Kiwi with the knowledge and tools to confidently manage their KiwiSaver, turning their savings into a source of security and opportunity.
                        </p>
                    </CardContent>
                </Card>
                 <Card className="text-center">
                    ...
                    <CardContent>
                        <p className="text-muted-foreground">
                            A future where all New Zealanders are financially literate and empowered to achieve their long-term goals, starting with a well-managed KiwiSaver.
                        </p>
                    </CardContent>
                </Card>
                 <Card className="text-center">
